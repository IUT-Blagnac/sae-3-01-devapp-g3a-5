...
=== Prérequis
Il faut télécharger Wamp pour déployer le projet sur sa propre machine, et l'héberger localement.

=== Lancement
On peut télécharger une release du projet et la sauvegarder dans son dossier Wamp. On lance le serveur et on peut y accéder en tapant `localhost` dans sa barre de recherche Google Chrome.
