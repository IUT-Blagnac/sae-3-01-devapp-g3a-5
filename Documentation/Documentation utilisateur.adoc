...
> **/!\** - Durant l'intégralité de la partie, la page index.php doit impérativement __rester ouverte__, même après le lancement du jeu dans la page admin. En effet, fermer la page interromprait la connexion entre les joueurs.
