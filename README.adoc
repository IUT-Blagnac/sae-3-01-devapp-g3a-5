...
|{la} |{us_}29"] |{is_t_o}30 "] {is_c_o}31 "] {is_d_o}32 "]|{doc_t}ihm_userphp "] {doc_u}i-introduction"]|{tst_wt}equipe-connexion"]|Equipe Connexion
|{la} |{us_}33"] |{is_t_o}34 "] {is_c_o}35 "] {is_d_o}36 "]|{doc_t}ihm_userphp "] {doc_u}i-introduction"]|{tst_wt}aaa"]|Rafraichir Equipes
