...
:tst_ok: image:{badge}Tests-OK-brightgreen.svg[link="{baseURL}/blob/{branch}/Documentation/Cahier%20de%20tests.adoc#
:tst_ko: image:{badge}Tests-Fail-red.svg[link="{baseURL}/blob/{branch}/Documentation/Documentation%20utilisateur.adoc#
