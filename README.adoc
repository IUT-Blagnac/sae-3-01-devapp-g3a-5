...
|{lo} |{us_}2"] |{is_t_o}50 "] {is_c_o}51 "] {is_d_o}52 "]|{doc_t}adaptabilité-du-plateau-de-jeu "] {doc_u}voir-données-equipes"]|{tst}aaa"]|Adapter le plateau de jeu
|{lo} |{us_}8"] |{is_t_o}50 "] {is_c_o}51 "] {is_d_o}52 "]|{doc_t}ihm_userphp "] {doc_u}voir-données-equipes"]|{tst}aaa"]|Couleur du plateau
|{ts} |{us_}16"] |{is_t_o}50 "] {is_c_o}51 "] {is_d_o}52 "]|{doc_t}protocole-de-communication "] {doc_u}voir-données-equipes"]|{tst}aaa"]|Connection au port serie
|{ts} |{us_}3"] |{is_t_o}50 "] {is_c_o}51 "] {is_d_o}52 "]|{doc_t}protocole-de-communication "] {doc_u}voir-données-equipes"]|{tst}aaa"]|Couleur aleatoire des joueurs 
