...
var CheckpointsCaches = true;
    ...
    function getListCheckpoints(){
      ...
      text = "";
        ...
        for(var target of listNodeWithColor[0].targets){
          text += "Checkpoint " + target + "<br>";
        }
    ...
    function getNbJoueurs(){
        ...
        return listNodeWithColor.length;
    }

    function getNbCheckpoints(){
        //TODO listNodeWithColor[0].targets.length;
